...
def look(x, y, direction, lvldict):
    ...
    if direction == "up":
        ...
        if (x - 1) != 0:
            left = lvldict[coords]
            print(lvldict[coords],"1")
        coords = str(y) + "-" + str(x + 1)
        if (x + 1) != 6:
            right = lvldict[coords]
            print(lvldict[coords], "2")
        coords = str(y + 1) + "-" + str(x)
        if (y + 1) != 8:
            middle = lvldict[coords]
            print(lvldict[coords], "3")
            print(middle)
...
while 1:
    ...
    ammo = y
    health = x
    disp_left, disp_middle, disp_right = look(x, y, "up", leveldict)
    ...
    last_key=""
    if weapon_action == "attack" and ticks_from_last_act == 0:
        weapon_action = "idle"
